<%@ Page Title="" Language="C#" MasterPageFile="~/SiteCliente.Master" AutoEventWireup="true" CodeBehind="ConfiguraCliente.aspx.cs" Inherits="webREINF.ConfiguraCliente" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                <asp:Button ID="Button1" runat="server" Text="Confirmar " ValidationGroup="1" OnClick="Button1_Click"/>
            </div>
        </div>
        <div class="row">
